...
public record AgentEvent(
    ...
    public static AgentEvent agentStarted(int totalSteps) {
        return new AgentEvent("agent_start", 0, totalSteps, "Agent started", null, null, null, System.currentTimeMillis());
    }

    public static AgentEvent stepStarted(int step, int total) {
        return new AgentEvent("step_start", step, total, "Step " + step + " started", null, null, null, System.currentTimeMillis());
    }

    public static AgentEvent thinking(int step, String thought) {
        return new AgentEvent("thinking", step, 0, thought, null, null, null, System.currentTimeMillis());
    }

    public static AgentEvent toolCall(int step, String name, String input) {
        return new AgentEvent("tool_call", step, 0, null, name, input, null, System.currentTimeMillis());
    }

    public static AgentEvent toolResult(int step, String name, String output) {
        return new AgentEvent("tool_result", step, 0, null, name, null, output, System.currentTimeMillis());
    }

    public static AgentEvent stepEnd(int step, String summary) {
        return new AgentEvent("step_end", step, 0, summary, null, null, null, System.currentTimeMillis());
    }

    public static AgentEvent agentFinished(String summary) {
        return new AgentEvent("agent_finish", 0, 0, summary, null, null, null, System.currentTimeMillis());
    }
    ...
    public static AgentEvent finalAnswer(int step, String content) {
        return new AgentEvent("final_answer", step, 0, content, null, null, null, System.currentTimeMillis());
    }

    public static AgentEvent agentError(int step, String error) {
        return new AgentEvent("agent_error", step, 0, error, null, null, null, System.currentTimeMillis());
    }
